...
def AddPlayer():
    ...
    """ W.I.P.<---
    name = input("What is the name of the new player? (First Last) =>")
    team = input("What team will he/she be on? (Provide TeamID) =>")
